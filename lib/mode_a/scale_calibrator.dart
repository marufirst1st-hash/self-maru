...
class ScaleCalibrator {
  ...
  /// 두 태그의 solvePnP 결과와 막대 실측 길이로 스케일 팩터 계산
  double calibrate(TagPose pose1, TagPose pose2, double rodLengthM) {
    final measured = _distance3D(pose1.tvec, pose2.tvec) / 100; // cm→m
    if (measured < 0.01) return _scaleFactor;
